...
if (
  ...
  .then(async ({ data, error }) => {
    ...
    if (currentUser) {
      ...
      console.warn(
        "No authenticated session yet — sign in to load Missions."
      );
...
async function updateHome() {
  ...
  const completedToday = profile?.last_complete_date === today;
  if ($("dailyStatus")) $("dailyStatus").textContent = completedToday
